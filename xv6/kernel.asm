...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 a1 58 10 80 	movl   $0x801058a1,0x14(%eax)
  p->context = (struct context*)sp;
...
80103c66:	e8 05 09 00 00       	call   80104570 <acquire>
...
80103c8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c92:	e8 0c 0c 00 00       	call   801048a3 <swtch>
      switchkvm();
...
80103d37:	e8 67 0b 00 00       	call   801048a3 <swtch>
  mycpu()->intena = intena;
...
80103d9a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d9d:	e8 ce 06 00 00       	call   80104470 <pushcli>
  c = mycpu();
80103da2:	e8 29 fb ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103da7:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103dad:	e8 0e 07 00 00       	call   801044c0 <popcli>
  if(curproc == initproc)
...
80103e0a:	e8 61 07 00 00       	call   80104570 <acquire>
...
80103ee0:	e8 8b 06 00 00       	call   80104570 <acquire>
  pushcli();
...
80103f0d:	e8 1e 07 00 00       	call   80104630 <release>
}
...
80103f30:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f33:	e8 38 05 00 00       	call   80104470 <pushcli>
  c = mycpu();
80103f38:	e8 93 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103f3d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f43:	e8 78 05 00 00       	call   801044c0 <popcli>
  if(p == 0)
...
80103f64:	e8 07 06 00 00       	call   80104570 <acquire>
    release(lk);
80103f69:	89 34 24             	mov    %esi,(%esp)
80103f6c:	e8 bf 06 00 00       	call   80104630 <release>
  p->chan = chan;
...
80103f8e:	e8 9d 06 00 00       	call   80104630 <release>
    acquire(lk);
...
80103f9f:	5d                   	pop    %ebp
    acquire(lk);
80103fa0:	e9 cb 05 00 00       	jmp    80104570 <acquire>
...
801040a6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040ad:	e8 7e 05 00 00       	call   80104630 <release>
        return pid;
...
801040cb:	e8 60 05 00 00       	call   80104630 <release>
      return -1;
...
801040f3:	e8 78 04 00 00       	call   80104570 <acquire>
...
80104138:	c9                   	leave  
  release(&ptable.lock);
80104139:	e9 f2 04 00 00       	jmp    80104630 <release>
...
80104153:	e8 18 04 00 00       	call   80104570 <acquire>
...
80104193:	e8 98 04 00 00       	call   80104630 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041b0:	e8 7b 04 00 00       	call   80104630 <release>
}
...
8010425d:	e8 ae 01 00 00       	call   80104410 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042a0:	f3 0f 1e fb          	endbr32 
  return 21;
801042a4:	b8 15 00 00 00       	mov    $0x15,%eax
801042a9:	c3                   	ret    
...
801042be:	68 64 77 10 80       	push   $0x80107764
...
8010431d:	e8 fe fb ff ff       	call   80103f20 <sleep>
  while (lk->locked) {
...
80104378:	e8 63 fd ff ff       	call   801040e0 <wakeup>
  release(&lk->lk);
...
80104505:	68 6f 77 10 80       	push   $0x8010776f
8010450a:	e8 81 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010450f:	83 ec 0c             	sub    $0xc,%esp
80104512:	68 86 77 10 80       	push   $0x80107786
...
80104617:	68 8d 77 10 80       	push   $0x8010778d
...
80104670:	68 95 77 10 80       	push   $0x80107795
...
80104a70:	8b 14 85 c0 77 10 80 	mov    -0x7fef8840(,%eax,4),%edx
...
801057c4:	68 60 4c 11 80       	push   $0x80114c60
801057c9:	e8 a2 ed ff ff       	call   80104570 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057ce:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057d1:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
801057e8:	68 a0 54 11 80       	push   $0x801154a0
801057ed:	e8 2e e7 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
801057f2:	a1 a0 54 11 80       	mov    0x801154a0,%eax
...
80105810:	68 60 4c 11 80       	push   $0x80114c60
...
80105858:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
8010585b:	68 60 4c 11 80       	push   $0x80114c60
80105860:	e8 0b ed ff ff       	call   80104570 <acquire>
  xticks = ticks;
80105865:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
8010586b:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
...
80105880:	f3 0f 1e fb          	endbr32 
  return getage();
80105884:	e9 17 ea ff ff       	jmp    801042a0 <getage>
...
80105a8c:	e8 df ea ff ff       	call   80104570 <acquire>
      wakeup(&ticks);
...
80105aab:	e8 80 eb ff ff       	call   80104630 <release>
...
80105b49:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b4c:	e8 ff ee ff ff       	call   80104a50 <syscall>
    if(myproc()->killed)
...
80105d3b:	6a 00                	push   $0x0
  jmp alltraps
80105d3d:	e9 47 fb ff ff       	jmp    80105889 <alltraps>
...
80105d44:	6a 01                	push   $0x1
  jmp alltraps
80105d46:	e9 3e fb ff ff       	jmp    80105889 <alltraps>
...
80105d4d:	6a 02                	push   $0x2
  jmp alltraps
80105d4f:	e9 35 fb ff ff       	jmp    80105889 <alltraps>
...
80105d56:	6a 03                	push   $0x3
  jmp alltraps
80105d58:	e9 2c fb ff ff       	jmp    80105889 <alltraps>
...
80105d5f:	6a 04                	push   $0x4
  jmp alltraps
80105d61:	e9 23 fb ff ff       	jmp    80105889 <alltraps>
...
80105d68:	6a 05                	push   $0x5
  jmp alltraps
80105d6a:	e9 1a fb ff ff       	jmp    80105889 <alltraps>
...
80105d71:	6a 06                	push   $0x6
  jmp alltraps
80105d73:	e9 11 fb ff ff       	jmp    80105889 <alltraps>
...
80105d7a:	6a 07                	push   $0x7
  jmp alltraps
80105d7c:	e9 08 fb ff ff       	jmp    80105889 <alltraps>
...
80105d81:	6a 08                	push   $0x8
  jmp alltraps
80105d83:	e9 01 fb ff ff       	jmp    80105889 <alltraps>
...
80105d8a:	6a 09                	push   $0x9
  jmp alltraps
80105d8c:	e9 f8 fa ff ff       	jmp    80105889 <alltraps>
...
80105d91:	6a 0a                	push   $0xa
  jmp alltraps
80105d93:	e9 f1 fa ff ff       	jmp    80105889 <alltraps>
...
80105d98:	6a 0b                	push   $0xb
  jmp alltraps
80105d9a:	e9 ea fa ff ff       	jmp    80105889 <alltraps>
...
80105d9f:	6a 0c                	push   $0xc
  jmp alltraps
80105da1:	e9 e3 fa ff ff       	jmp    80105889 <alltraps>
...
80105dbf:	6a 10                	push   $0x10
  jmp alltraps
80105dc1:	e9 c3 fa ff ff       	jmp    80105889 <alltraps>
...
80105dc6:	6a 11                	push   $0x11
  jmp alltraps
80105dc8:	e9 bc fa ff ff       	jmp    80105889 <alltraps>
...
80105dcf:	6a 12                	push   $0x12
  jmp alltraps
80105dd1:	e9 b3 fa ff ff       	jmp    80105889 <alltraps>
...
80105dd8:	6a 13                	push   $0x13
  jmp alltraps
80105dda:	e9 aa fa ff ff       	jmp    80105889 <alltraps>
...
80105de1:	6a 14                	push   $0x14
  jmp alltraps
80105de3:	e9 a1 fa ff ff       	jmp    80105889 <alltraps>
...
80105dea:	6a 15                	push   $0x15
  jmp alltraps
80105dec:	e9 98 fa ff ff       	jmp    80105889 <alltraps>
...
80105df3:	6a 16                	push   $0x16
  jmp alltraps
80105df5:	e9 8f fa ff ff       	jmp    80105889 <alltraps>
...
80105dfc:	6a 17                	push   $0x17
  jmp alltraps
80105dfe:	e9 86 fa ff ff       	jmp    80105889 <alltraps>
...
80105e05:	6a 18                	push   $0x18
  jmp alltraps
80105e07:	e9 7d fa ff ff       	jmp    80105889 <alltraps>
...
80105e0e:	6a 19                	push   $0x19
  jmp alltraps
80105e10:	e9 74 fa ff ff       	jmp    80105889 <alltraps>
...
80105e17:	6a 1a                	push   $0x1a
  jmp alltraps
80105e19:	e9 6b fa ff ff       	jmp    80105889 <alltraps>
...
80105e20:	6a 1b                	push   $0x1b
  jmp alltraps
80105e22:	e9 62 fa ff ff       	jmp    80105889 <alltraps>
...
80105e29:	6a 1c                	push   $0x1c
  jmp alltraps
80105e2b:	e9 59 fa ff ff       	jmp    80105889 <alltraps>
...
80105e32:	6a 1d                	push   $0x1d
  jmp alltraps
80105e34:	e9 50 fa ff ff       	jmp    80105889 <alltraps>
...
80105e3b:	6a 1e                	push   $0x1e
  jmp alltraps
80105e3d:	e9 47 fa ff ff       	jmp    80105889 <alltraps>
...
80105e44:	6a 1f                	push   $0x1f
  jmp alltraps
80105e46:	e9 3e fa ff ff       	jmp    80105889 <alltraps>
...
80105e4d:	6a 20                	push   $0x20
  jmp alltraps
80105e4f:	e9 35 fa ff ff       	jmp    80105889 <alltraps>
...
80105e56:	6a 21                	push   $0x21
  jmp alltraps
80105e58:	e9 2c fa ff ff       	jmp    80105889 <alltraps>
...
80105e5f:	6a 22                	push   $0x22
  jmp alltraps
80105e61:	e9 23 fa ff ff       	jmp    80105889 <alltraps>
...
80105e68:	6a 23                	push   $0x23
  jmp alltraps
80105e6a:	e9 1a fa ff ff       	jmp    80105889 <alltraps>
...
80105e71:	6a 24                	push   $0x24
  jmp alltraps
80105e73:	e9 11 fa ff ff       	jmp    80105889 <alltraps>
...
80105e7a:	6a 25                	push   $0x25
  jmp alltraps
80105e7c:	e9 08 fa ff ff       	jmp    80105889 <alltraps>
...
80105e83:	6a 26                	push   $0x26
  jmp alltraps
80105e85:	e9 ff f9 ff ff       	jmp    80105889 <alltraps>
...
80105e8c:	6a 27                	push   $0x27
  jmp alltraps
80105e8e:	e9 f6 f9 ff ff       	jmp    80105889 <alltraps>
...
80105e95:	6a 28                	push   $0x28
  jmp alltraps
80105e97:	e9 ed f9 ff ff       	jmp    80105889 <alltraps>
...
80105e9e:	6a 29                	push   $0x29
  jmp alltraps
80105ea0:	e9 e4 f9 ff ff       	jmp    80105889 <alltraps>
...
80105ea7:	6a 2a                	push   $0x2a
  jmp alltraps
80105ea9:	e9 db f9 ff ff       	jmp    80105889 <alltraps>
...
80105eb0:	6a 2b                	push   $0x2b
  jmp alltraps
80105eb2:	e9 d2 f9 ff ff       	jmp    80105889 <alltraps>
...
80105eb9:	6a 2c                	push   $0x2c
  jmp alltraps
80105ebb:	e9 c9 f9 ff ff       	jmp    80105889 <alltraps>
...
80105ec2:	6a 2d                	push   $0x2d
  jmp alltraps
80105ec4:	e9 c0 f9 ff ff       	jmp    80105889 <alltraps>
...
80105ecb:	6a 2e                	push   $0x2e
  jmp alltraps
80105ecd:	e9 b7 f9 ff ff       	jmp    80105889 <alltraps>
...
80105ed4:	6a 2f                	push   $0x2f
  jmp alltraps
80105ed6:	e9 ae f9 ff ff       	jmp    80105889 <alltraps>
...
80105edd:	6a 30                	push   $0x30
  jmp alltraps
80105edf:	e9 a5 f9 ff ff       	jmp    80105889 <alltraps>
...
80105ee6:	6a 31                	push   $0x31
  jmp alltraps
80105ee8:	e9 9c f9 ff ff       	jmp    80105889 <alltraps>
...
80105eef:	6a 32                	push   $0x32
  jmp alltraps
80105ef1:	e9 93 f9 ff ff       	jmp    80105889 <alltraps>
...
80105ef8:	6a 33                	push   $0x33
  jmp alltraps
80105efa:	e9 8a f9 ff ff       	jmp    80105889 <alltraps>
...
80105f01:	6a 34                	push   $0x34
  jmp alltraps
80105f03:	e9 81 f9 ff ff       	jmp    80105889 <alltraps>
...
80105f0a:	6a 35                	push   $0x35
  jmp alltraps
80105f0c:	e9 78 f9 ff ff       	jmp    80105889 <alltraps>
...
80105f13:	6a 36                	push   $0x36
  jmp alltraps
80105f15:	e9 6f f9 ff ff       	jmp    80105889 <alltraps>
...
80105f1c:	6a 37                	push   $0x37
  jmp alltraps
80105f1e:	e9 66 f9 ff ff       	jmp    80105889 <alltraps>
...
80105f25:	6a 38                	push   $0x38
  jmp alltraps
80105f27:	e9 5d f9 ff ff       	jmp    80105889 <alltraps>
...
80105f2e:	6a 39                	push   $0x39
  jmp alltraps
80105f30:	e9 54 f9 ff ff       	jmp    80105889 <alltraps>
...
80105f37:	6a 3a                	push   $0x3a
  jmp alltraps
80105f39:	e9 4b f9 ff ff       	jmp    80105889 <alltraps>
...
80105f40:	6a 3b                	push   $0x3b
  jmp alltraps
80105f42:	e9 42 f9 ff ff       	jmp    80105889 <alltraps>
...
80105f49:	6a 3c                	push   $0x3c
  jmp alltraps
80105f4b:	e9 39 f9 ff ff       	jmp    80105889 <alltraps>
...
80105f52:	6a 3d                	push   $0x3d
  jmp alltraps
80105f54:	e9 30 f9 ff ff       	jmp    80105889 <alltraps>
...
80105f5b:	6a 3e                	push   $0x3e
  jmp alltraps
80105f5d:	e9 27 f9 ff ff       	jmp    80105889 <alltraps>
...
80105f64:	6a 3f                	push   $0x3f
  jmp alltraps
80105f66:	e9 1e f9 ff ff       	jmp    80105889 <alltraps>
...
80105f6d:	6a 40                	push   $0x40
  jmp alltraps
80105f6f:	e9 15 f9 ff ff       	jmp    80105889 <alltraps>
...
80105f76:	6a 41                	push   $0x41
  jmp alltraps
80105f78:	e9 0c f9 ff ff       	jmp    80105889 <alltraps>
...
80105f7f:	6a 42                	push   $0x42
  jmp alltraps
80105f81:	e9 03 f9 ff ff       	jmp    80105889 <alltraps>
...
80105f88:	6a 43                	push   $0x43
  jmp alltraps
80105f8a:	e9 fa f8 ff ff       	jmp    80105889 <alltraps>
...
80105f91:	6a 44                	push   $0x44
  jmp alltraps
80105f93:	e9 f1 f8 ff ff       	jmp    80105889 <alltraps>
...
80105f9a:	6a 45                	push   $0x45
  jmp alltraps
80105f9c:	e9 e8 f8 ff ff       	jmp    80105889 <alltraps>
...
80105fa3:	6a 46                	push   $0x46
  jmp alltraps
80105fa5:	e9 df f8 ff ff       	jmp    80105889 <alltraps>
...
80105fac:	6a 47                	push   $0x47
  jmp alltraps
80105fae:	e9 d6 f8 ff ff       	jmp    80105889 <alltraps>
...
80105fb5:	6a 48                	push   $0x48
  jmp alltraps
80105fb7:	e9 cd f8 ff ff       	jmp    80105889 <alltraps>
...
80105fbe:	6a 49                	push   $0x49
  jmp alltraps
80105fc0:	e9 c4 f8 ff ff       	jmp    80105889 <alltraps>
...
80105fc7:	6a 4a                	push   $0x4a
  jmp alltraps
80105fc9:	e9 bb f8 ff ff       	jmp    80105889 <alltraps>
...
80105fd0:	6a 4b                	push   $0x4b
  jmp alltraps
80105fd2:	e9 b2 f8 ff ff       	jmp    80105889 <alltraps>
...
80105fd9:	6a 4c                	push   $0x4c
  jmp alltraps
80105fdb:	e9 a9 f8 ff ff       	jmp    80105889 <alltraps>
...
80105fe2:	6a 4d                	push   $0x4d
  jmp alltraps
80105fe4:	e9 a0 f8 ff ff       	jmp    80105889 <alltraps>
...
80105feb:	6a 4e                	push   $0x4e
  jmp alltraps
80105fed:	e9 97 f8 ff ff       	jmp    80105889 <alltraps>
...
80105ff4:	6a 4f                	push   $0x4f
  jmp alltraps
80105ff6:	e9 8e f8 ff ff       	jmp    80105889 <alltraps>
...
80105ffd:	6a 50                	push   $0x50
  jmp alltraps
80105fff:	e9 85 f8 ff ff       	jmp    80105889 <alltraps>
...
80106006:	6a 51                	push   $0x51
  jmp alltraps
80106008:	e9 7c f8 ff ff       	jmp    80105889 <alltraps>
...
8010600f:	6a 52                	push   $0x52
  jmp alltraps
80106011:	e9 73 f8 ff ff       	jmp    80105889 <alltraps>
...
80106018:	6a 53                	push   $0x53
  jmp alltraps
8010601a:	e9 6a f8 ff ff       	jmp    80105889 <alltraps>
...
80106021:	6a 54                	push   $0x54
  jmp alltraps
80106023:	e9 61 f8 ff ff       	jmp    80105889 <alltraps>
...
8010602a:	6a 55                	push   $0x55
  jmp alltraps
8010602c:	e9 58 f8 ff ff       	jmp    80105889 <alltraps>
...
80106033:	6a 56                	push   $0x56
  jmp alltraps
80106035:	e9 4f f8 ff ff       	jmp    80105889 <alltraps>
...
8010603c:	6a 57                	push   $0x57
  jmp alltraps
8010603e:	e9 46 f8 ff ff       	jmp    80105889 <alltraps>
...
80106045:	6a 58                	push   $0x58
  jmp alltraps
80106047:	e9 3d f8 ff ff       	jmp    80105889 <alltraps>
...
8010604e:	6a 59                	push   $0x59
  jmp alltraps
80106050:	e9 34 f8 ff ff       	jmp    80105889 <alltraps>
...
80106057:	6a 5a                	push   $0x5a
  jmp alltraps
80106059:	e9 2b f8 ff ff       	jmp    80105889 <alltraps>
...
80106060:	6a 5b                	push   $0x5b
  jmp alltraps
80106062:	e9 22 f8 ff ff       	jmp    80105889 <alltraps>
...
80106069:	6a 5c                	push   $0x5c
  jmp alltraps
8010606b:	e9 19 f8 ff ff       	jmp    80105889 <alltraps>
...
80106072:	6a 5d                	push   $0x5d
  jmp alltraps
80106074:	e9 10 f8 ff ff       	jmp    80105889 <alltraps>
...
8010607b:	6a 5e                	push   $0x5e
  jmp alltraps
8010607d:	e9 07 f8 ff ff       	jmp    80105889 <alltraps>
...
80106084:	6a 5f                	push   $0x5f
  jmp alltraps
80106086:	e9 fe f7 ff ff       	jmp    80105889 <alltraps>
...
8010608d:	6a 60                	push   $0x60
  jmp alltraps
8010608f:	e9 f5 f7 ff ff       	jmp    80105889 <alltraps>
...
80106096:	6a 61                	push   $0x61
  jmp alltraps
80106098:	e9 ec f7 ff ff       	jmp    80105889 <alltraps>
...
8010609f:	6a 62                	push   $0x62
  jmp alltraps
801060a1:	e9 e3 f7 ff ff       	jmp    80105889 <alltraps>
...
801060a8:	6a 63                	push   $0x63
  jmp alltraps
801060aa:	e9 da f7 ff ff       	jmp    80105889 <alltraps>
...
801060b1:	6a 64                	push   $0x64
  jmp alltraps
801060b3:	e9 d1 f7 ff ff       	jmp    80105889 <alltraps>
...
801060ba:	6a 65                	push   $0x65
  jmp alltraps
801060bc:	e9 c8 f7 ff ff       	jmp    80105889 <alltraps>
...
801060c3:	6a 66                	push   $0x66
  jmp alltraps
801060c5:	e9 bf f7 ff ff       	jmp    80105889 <alltraps>
...
801060cc:	6a 67                	push   $0x67
  jmp alltraps
801060ce:	e9 b6 f7 ff ff       	jmp    80105889 <alltraps>
...
801060d5:	6a 68                	push   $0x68
  jmp alltraps
801060d7:	e9 ad f7 ff ff       	jmp    80105889 <alltraps>
...
801060de:	6a 69                	push   $0x69
  jmp alltraps
801060e0:	e9 a4 f7 ff ff       	jmp    80105889 <alltraps>
...
801060e7:	6a 6a                	push   $0x6a
  jmp alltraps
801060e9:	e9 9b f7 ff ff       	jmp    80105889 <alltraps>
...
801060f0:	6a 6b                	push   $0x6b
  jmp alltraps
801060f2:	e9 92 f7 ff ff       	jmp    80105889 <alltraps>
...
801060f9:	6a 6c                	push   $0x6c
  jmp alltraps
801060fb:	e9 89 f7 ff ff       	jmp    80105889 <alltraps>
...
80106102:	6a 6d                	push   $0x6d
  jmp alltraps
80106104:	e9 80 f7 ff ff       	jmp    80105889 <alltraps>
...
8010610b:	6a 6e                	push   $0x6e
  jmp alltraps
8010610d:	e9 77 f7 ff ff       	jmp    80105889 <alltraps>
...
80106114:	6a 6f                	push   $0x6f
  jmp alltraps
80106116:	e9 6e f7 ff ff       	jmp    80105889 <alltraps>
...
8010611d:	6a 70                	push   $0x70
  jmp alltraps
8010611f:	e9 65 f7 ff ff       	jmp    80105889 <alltraps>
...
80106126:	6a 71                	push   $0x71
  jmp alltraps
80106128:	e9 5c f7 ff ff       	jmp    80105889 <alltraps>
...
8010612f:	6a 72                	push   $0x72
  jmp alltraps
80106131:	e9 53 f7 ff ff       	jmp    80105889 <alltraps>
...
80106138:	6a 73                	push   $0x73
  jmp alltraps
8010613a:	e9 4a f7 ff ff       	jmp    80105889 <alltraps>
...
80106141:	6a 74                	push   $0x74
  jmp alltraps
80106143:	e9 41 f7 ff ff       	jmp    80105889 <alltraps>
...
8010614a:	6a 75                	push   $0x75
  jmp alltraps
8010614c:	e9 38 f7 ff ff       	jmp    80105889 <alltraps>
...
80106153:	6a 76                	push   $0x76
  jmp alltraps
80106155:	e9 2f f7 ff ff       	jmp    80105889 <alltraps>
...
8010615c:	6a 77                	push   $0x77
  jmp alltraps
8010615e:	e9 26 f7 ff ff       	jmp    80105889 <alltraps>
...
80106165:	6a 78                	push   $0x78
  jmp alltraps
80106167:	e9 1d f7 ff ff       	jmp    80105889 <alltraps>
...
8010616e:	6a 79                	push   $0x79
  jmp alltraps
80106170:	e9 14 f7 ff ff       	jmp    80105889 <alltraps>
...
80106177:	6a 7a                	push   $0x7a
  jmp alltraps
80106179:	e9 0b f7 ff ff       	jmp    80105889 <alltraps>
...
80106180:	6a 7b                	push   $0x7b
  jmp alltraps
80106182:	e9 02 f7 ff ff       	jmp    80105889 <alltraps>
...
80106189:	6a 7c                	push   $0x7c
  jmp alltraps
8010618b:	e9 f9 f6 ff ff       	jmp    80105889 <alltraps>
...
80106192:	6a 7d                	push   $0x7d
  jmp alltraps
80106194:	e9 f0 f6 ff ff       	jmp    80105889 <alltraps>
...
8010619b:	6a 7e                	push   $0x7e
  jmp alltraps
8010619d:	e9 e7 f6 ff ff       	jmp    80105889 <alltraps>
...
801061a4:	6a 7f                	push   $0x7f
  jmp alltraps
801061a6:	e9 de f6 ff ff       	jmp    80105889 <alltraps>
...
801061ad:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801061b2:	e9 d2 f6 ff ff       	jmp    80105889 <alltraps>
...
801061b9:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801061be:	e9 c6 f6 ff ff       	jmp    80105889 <alltraps>
...
801061c5:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801061ca:	e9 ba f6 ff ff       	jmp    80105889 <alltraps>
...
801061d1:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801061d6:	e9 ae f6 ff ff       	jmp    80105889 <alltraps>
...
801061dd:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801061e2:	e9 a2 f6 ff ff       	jmp    80105889 <alltraps>
...
801061e9:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801061ee:	e9 96 f6 ff ff       	jmp    80105889 <alltraps>
...
801061f5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801061fa:	e9 8a f6 ff ff       	jmp    80105889 <alltraps>
...
80106201:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106206:	e9 7e f6 ff ff       	jmp    80105889 <alltraps>
...
8010620d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106212:	e9 72 f6 ff ff       	jmp    80105889 <alltraps>
...
80106219:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010621e:	e9 66 f6 ff ff       	jmp    80105889 <alltraps>
...
80106225:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010622a:	e9 5a f6 ff ff       	jmp    80105889 <alltraps>
...
80106231:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106236:	e9 4e f6 ff ff       	jmp    80105889 <alltraps>
...
8010623d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106242:	e9 42 f6 ff ff       	jmp    80105889 <alltraps>
...
80106249:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010624e:	e9 36 f6 ff ff       	jmp    80105889 <alltraps>
...
80106255:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010625a:	e9 2a f6 ff ff       	jmp    80105889 <alltraps>
...
80106261:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106266:	e9 1e f6 ff ff       	jmp    80105889 <alltraps>
...
8010626d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106272:	e9 12 f6 ff ff       	jmp    80105889 <alltraps>
...
80106279:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010627e:	e9 06 f6 ff ff       	jmp    80105889 <alltraps>
...
80106285:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010628a:	e9 fa f5 ff ff       	jmp    80105889 <alltraps>
...
80106291:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106296:	e9 ee f5 ff ff       	jmp    80105889 <alltraps>
...
8010629d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801062a2:	e9 e2 f5 ff ff       	jmp    80105889 <alltraps>
...
801062a9:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801062ae:	e9 d6 f5 ff ff       	jmp    80105889 <alltraps>
...
801062b5:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801062ba:	e9 ca f5 ff ff       	jmp    80105889 <alltraps>
...
801062c1:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801062c6:	e9 be f5 ff ff       	jmp    80105889 <alltraps>
...
801062cd:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801062d2:	e9 b2 f5 ff ff       	jmp    80105889 <alltraps>
...
801062d9:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801062de:	e9 a6 f5 ff ff       	jmp    80105889 <alltraps>
...
801062e5:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801062ea:	e9 9a f5 ff ff       	jmp    80105889 <alltraps>
...
801062f1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801062f6:	e9 8e f5 ff ff       	jmp    80105889 <alltraps>
...
801062fd:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106302:	e9 82 f5 ff ff       	jmp    80105889 <alltraps>
...
80106309:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010630e:	e9 76 f5 ff ff       	jmp    80105889 <alltraps>
...
80106315:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010631a:	e9 6a f5 ff ff       	jmp    80105889 <alltraps>
...
80106321:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106326:	e9 5e f5 ff ff       	jmp    80105889 <alltraps>
...
8010632d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106332:	e9 52 f5 ff ff       	jmp    80105889 <alltraps>
...
80106339:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010633e:	e9 46 f5 ff ff       	jmp    80105889 <alltraps>
...
80106345:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010634a:	e9 3a f5 ff ff       	jmp    80105889 <alltraps>
...
80106351:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106356:	e9 2e f5 ff ff       	jmp    80105889 <alltraps>
...
8010635d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106362:	e9 22 f5 ff ff       	jmp    80105889 <alltraps>
...
80106369:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010636e:	e9 16 f5 ff ff       	jmp    80105889 <alltraps>
...
80106375:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010637a:	e9 0a f5 ff ff       	jmp    80105889 <alltraps>
...
80106381:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106386:	e9 fe f4 ff ff       	jmp    80105889 <alltraps>
...
8010638d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106392:	e9 f2 f4 ff ff       	jmp    80105889 <alltraps>
...
80106399:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010639e:	e9 e6 f4 ff ff       	jmp    80105889 <alltraps>
...
801063a5:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801063aa:	e9 da f4 ff ff       	jmp    80105889 <alltraps>
...
801063b1:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801063b6:	e9 ce f4 ff ff       	jmp    80105889 <alltraps>
...
801063bd:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801063c2:	e9 c2 f4 ff ff       	jmp    80105889 <alltraps>
...
801063c9:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801063ce:	e9 b6 f4 ff ff       	jmp    80105889 <alltraps>
...
801063d5:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801063da:	e9 aa f4 ff ff       	jmp    80105889 <alltraps>
...
801063e1:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801063e6:	e9 9e f4 ff ff       	jmp    80105889 <alltraps>
...
801063ed:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801063f2:	e9 92 f4 ff ff       	jmp    80105889 <alltraps>
...
801063f9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801063fe:	e9 86 f4 ff ff       	jmp    80105889 <alltraps>
...
80106405:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010640a:	e9 7a f4 ff ff       	jmp    80105889 <alltraps>
...
80106411:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106416:	e9 6e f4 ff ff       	jmp    80105889 <alltraps>
...
8010641d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106422:	e9 62 f4 ff ff       	jmp    80105889 <alltraps>
...
80106429:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010642e:	e9 56 f4 ff ff       	jmp    80105889 <alltraps>
...
80106435:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010643a:	e9 4a f4 ff ff       	jmp    80105889 <alltraps>
...
80106441:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106446:	e9 3e f4 ff ff       	jmp    80105889 <alltraps>
...
8010644d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106452:	e9 32 f4 ff ff       	jmp    80105889 <alltraps>
...
80106459:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010645e:	e9 26 f4 ff ff       	jmp    80105889 <alltraps>
...
80106465:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010646a:	e9 1a f4 ff ff       	jmp    80105889 <alltraps>
...
80106471:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106476:	e9 0e f4 ff ff       	jmp    80105889 <alltraps>
...
8010647d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106482:	e9 02 f4 ff ff       	jmp    80105889 <alltraps>
...
80106489:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010648e:	e9 f6 f3 ff ff       	jmp    80105889 <alltraps>
...
80106495:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010649a:	e9 ea f3 ff ff       	jmp    80105889 <alltraps>
...
801064a1:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801064a6:	e9 de f3 ff ff       	jmp    80105889 <alltraps>
...
801064ad:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801064b2:	e9 d2 f3 ff ff       	jmp    80105889 <alltraps>
...
801064b9:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801064be:	e9 c6 f3 ff ff       	jmp    80105889 <alltraps>
...
801064c5:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801064ca:	e9 ba f3 ff ff       	jmp    80105889 <alltraps>
...
801064d1:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801064d6:	e9 ae f3 ff ff       	jmp    80105889 <alltraps>
...
801064dd:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801064e2:	e9 a2 f3 ff ff       	jmp    80105889 <alltraps>
...
801064e9:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801064ee:	e9 96 f3 ff ff       	jmp    80105889 <alltraps>
...
801064f5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801064fa:	e9 8a f3 ff ff       	jmp    80105889 <alltraps>
...
80106501:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106506:	e9 7e f3 ff ff       	jmp    80105889 <alltraps>
...
8010650d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106512:	e9 72 f3 ff ff       	jmp    80105889 <alltraps>
...
80106519:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010651e:	e9 66 f3 ff ff       	jmp    80105889 <alltraps>
...
80106525:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010652a:	e9 5a f3 ff ff       	jmp    80105889 <alltraps>
...
80106531:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106536:	e9 4e f3 ff ff       	jmp    80105889 <alltraps>
...
8010653d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106542:	e9 42 f3 ff ff       	jmp    80105889 <alltraps>
...
80106549:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010654e:	e9 36 f3 ff ff       	jmp    80105889 <alltraps>
...
80106555:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010655a:	e9 2a f3 ff ff       	jmp    80105889 <alltraps>
...
80106561:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106566:	e9 1e f3 ff ff       	jmp    80105889 <alltraps>
...
8010656d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106572:	e9 12 f3 ff ff       	jmp    80105889 <alltraps>
...
80106579:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010657e:	e9 06 f3 ff ff       	jmp    80105889 <alltraps>
...
80106585:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010658a:	e9 fa f2 ff ff       	jmp    80105889 <alltraps>
...
80106591:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106596:	e9 ee f2 ff ff       	jmp    80105889 <alltraps>
...
8010659d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801065a2:	e9 e2 f2 ff ff       	jmp    80105889 <alltraps>
...
801065a9:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801065ae:	e9 d6 f2 ff ff       	jmp    80105889 <alltraps>
...
801065b5:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801065ba:	e9 ca f2 ff ff       	jmp    80105889 <alltraps>
...
801065c1:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801065c6:	e9 be f2 ff ff       	jmp    80105889 <alltraps>
...
801065cd:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801065d2:	e9 b2 f2 ff ff       	jmp    80105889 <alltraps>
...
801065d9:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801065de:	e9 a6 f2 ff ff       	jmp    80105889 <alltraps>
...
801065e5:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801065ea:	e9 9a f2 ff ff       	jmp    80105889 <alltraps>
...
801065f1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801065f6:	e9 8e f2 ff ff       	jmp    80105889 <alltraps>
...
801065fd:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106602:	e9 82 f2 ff ff       	jmp    80105889 <alltraps>
...
80106609:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010660e:	e9 76 f2 ff ff       	jmp    80105889 <alltraps>
...
80106615:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010661a:	e9 6a f2 ff ff       	jmp    80105889 <alltraps>
...
80106621:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106626:	e9 5e f2 ff ff       	jmp    80105889 <alltraps>
...
8010662d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106632:	e9 52 f2 ff ff       	jmp    80105889 <alltraps>
...
80106639:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010663e:	e9 46 f2 ff ff       	jmp    80105889 <alltraps>
...
80106645:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010664a:	e9 3a f2 ff ff       	jmp    80105889 <alltraps>
...
80106651:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106656:	e9 2e f2 ff ff       	jmp    80105889 <alltraps>
...
8010665d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106662:	e9 22 f2 ff ff       	jmp    80105889 <alltraps>
...
80106669:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010666e:	e9 16 f2 ff ff       	jmp    80105889 <alltraps>
...
80106675:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010667a:	e9 0a f2 ff ff       	jmp    80105889 <alltraps>
...
80106681:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106686:	e9 fe f1 ff ff       	jmp    80105889 <alltraps>
...
8010668d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106692:	e9 f2 f1 ff ff       	jmp    80105889 <alltraps>
...
80106699:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010669e:	e9 e6 f1 ff ff       	jmp    80105889 <alltraps>
...
801066a5:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801066aa:	e9 da f1 ff ff       	jmp    80105889 <alltraps>
...
801066b1:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801066b6:	e9 ce f1 ff ff       	jmp    80105889 <alltraps>
...
801066bd:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801066c2:	e9 c2 f1 ff ff       	jmp    80105889 <alltraps>
...
801066c9:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801066ce:	e9 b6 f1 ff ff       	jmp    80105889 <alltraps>
...
801066d5:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801066da:	e9 aa f1 ff ff       	jmp    80105889 <alltraps>
...
801066e1:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801066e6:	e9 9e f1 ff ff       	jmp    80105889 <alltraps>
...
801066ed:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801066f2:	e9 92 f1 ff ff       	jmp    80105889 <alltraps>
...
801066f9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801066fe:	e9 86 f1 ff ff       	jmp    80105889 <alltraps>
...
80106705:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010670a:	e9 7a f1 ff ff       	jmp    80105889 <alltraps>
...
80106711:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106716:	e9 6e f1 ff ff       	jmp    80105889 <alltraps>
...
8010671d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106722:	e9 62 f1 ff ff       	jmp    80105889 <alltraps>
...
80106729:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010672e:	e9 56 f1 ff ff       	jmp    80105889 <alltraps>
...
80106735:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010673a:	e9 4a f1 ff ff       	jmp    80105889 <alltraps>
...
80106741:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106746:	e9 3e f1 ff ff       	jmp    80105889 <alltraps>
...
8010674d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106752:	e9 32 f1 ff ff       	jmp    80105889 <alltraps>
...
80106759:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010675e:	e9 26 f1 ff ff       	jmp    80105889 <alltraps>
...
80106765:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010676a:	e9 1a f1 ff ff       	jmp    80105889 <alltraps>
...
80106771:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106776:	e9 0e f1 ff ff       	jmp    80105889 <alltraps>
...
8010677d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106782:	e9 02 f1 ff ff       	jmp    80105889 <alltraps>
...
80106789:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010678e:	e9 f6 f0 ff ff       	jmp    80105889 <alltraps>
...
80106795:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010679a:	e9 ea f0 ff ff       	jmp    80105889 <alltraps>
...
801067a1:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801067a6:	e9 de f0 ff ff       	jmp    80105889 <alltraps>
...
8010680a:	e8 71 de ff ff       	call   80104680 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a48:	0f 84 c2 00 00 00    	je     80106b10 <switchuvm+0xf0>
  pushcli();
80106a4e:	e8 1d da ff ff       	call   80104470 <pushcli>
...
80106afd:	5d                   	pop    %ebp
  popcli();
80106afe:	e9 bd d9 ff ff       	jmp    801044c0 <popcli>
...
80106b63:	e8 18 db ff ff       	call   80104680 <memset>
...
80106b96:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b97:	e9 84 db ff ff       	jmp    80104720 <memmove>
...
80106ccb:	e8 b0 d9 ff ff       	call   80104680 <memset>
...
80106e84:	e8 f7 d7 ff ff       	call   80104680 <memset>
...
8010709e:	e8 7d d6 ff ff       	call   80104720 <memmove>
    len -= n;
    buf += n;
